...
LIB_UI_SRCS=dpmiutil.cpp vga.cpp mouse.cpp keyboard.cpp textmode.cpp list.cpp ui_event.cpp ui_common.cpp ui_label.cpp ui_btn.cpp ui_input.cpp ui_lsbox.cpp ui_piano.cpp ui_range.cpp ui_sheet.cpp ui_load.cpp cmponent.cpp
