 ...
 * @return uint8_t
 */
uint8_t opl2_read() { return inp(OPL2_PORT_ADDR); }
 ...
 */
uint8_t opl2_getChipRegisterOffset(uint8_t reg) {
    switch (reg & 0xFF) {
        case 0x08:
            return 1;
        case 0xBD:
 ...
 */
uint8_t opl2_getChannelRegisterOffset(uint8_t baseRegister, uint8_t channel) {
    uint8_t offset;
 ...
 */
uint16_t opl2_getOperatorRegisterOffset(uint8_t baseRegister, uint8_t channel, uint8_t operatorNum) {
    uint16_t offset;
 ...
 */
uint8_t opl2_getRegisterOffset(uint8_t channel, uint8_t operatorNum) { return opl2_registerOffsets[operatorNum % 2][channel % OPL2_CHANNELS_PER_BANK]; }
 ...
 */
uint8_t opl2_getChipRegister(uint8_t reg) { return opl2_chipRegisters[opl2_getChipRegisterOffset(reg)]; }
 ...
 */
void opl2_setChipRegister(uint8_t reg, uint8_t value) {
 ...
 */
uint8_t opl2_getChannelRegister(uint8_t baseRegister, uint8_t channel) { return opl2_channelRegisters[opl2_getChannelRegisterOffset(baseRegister, channel)]; }
 ...
 * @param value - The value to write to the register.
 */
void opl2_setChannelRegister(uint8_t baseRegister, uint8_t channel, uint8_t value) {
    uint8_t reg;
 ...
 */
uint8_t opl2_getOperatorRegister(uint8_t baseRegister, uint8_t channel, uint8_t operatorNum) {
 ...
 */
void opl2_setOperatorRegister(uint8_t baseRegister, uint8_t channel, uint8_t operatorNum, uint8_t value) {
    uint8_t reg;
